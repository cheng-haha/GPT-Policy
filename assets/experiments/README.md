...
Three representative successful runs were added from the [experiment record](https://morphicrobot.feishu.cn/docx/XELDdCILeoYJJFxXHdPc1svgnbe), revision 1516. Existing task videos remain unchanged; the gallery shows one robot demo per task.
